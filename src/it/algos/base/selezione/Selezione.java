 ...
 * @version 1.0 / 3-4-05
 */
public interface Selezione extends Generale {

    /**
     * Codifica del nome-chiave interno del modulo
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "Selezione";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "selezione";

    /**
     * Codifica del voce della finestra
     * (usato nel Navigatore)
     */
    public static final String TITOLO_FINESTRA = "Selezioni";

    /**
     * Codifica del voce del modulo come appare nel Menu Moduli
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Selezione";
     ...
     * (oltre a quelli standard della superclasse)
     */
    public static final String CAMPO_MODULO = "campomodulo";

    public static final String CAMPO_NOME = "camponome";

    public static final String CAMPO_DATI = "campodati";

    public static final String CAMPO_PRIVATA = "campoprivata";
