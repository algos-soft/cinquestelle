 ...
 * <li> Costruisce il menu standard aiuto e le sue righe di menu </li>
 ...
 */
public final class MenuHelp extends MenuBase {

    /**
     * voce del menu come viene visualizzato nella finestra
     */
    private static final String TITOLO = "Help";
     ...
     */
    public MenuHelp(HashMap azioni) {
    ...
    private void inizia() throws Exception {
        super.aggiunge(Azione.ABOUT);
        super.addSeparator();
        super.aggiunge(Azione.HELP);
        super.aggiunge(Azione.HELP_PROGRAMMATORE);
        super.addSeparator();
        super.aggiunge(Azione.UPDATE);
