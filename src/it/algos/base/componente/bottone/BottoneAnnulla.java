 ...
 * @version 1.0  /
 * Creato:       il 3 novembre 2003 alle 16.11
 */
//-----------------------------------------------------------------------------
 ...
 * A - Costruire un bottone per annulare l'operazione <br>
 *
 * @author Guido Andrea Ceresa
 * @author Alberto Colombo
 * @author Alessandro Valbonesi
 * @author gac
 * @version 1.0  /  3 novembre 2003 ore 16.11
 */
public final class BottoneAnnulla extends BottoneBase {
...
//                unAzione = new AzioneChiudeFinestraOldOld();@todo ripristinare
            ...
            if (unAzione != null) {   //@todo levare
                super.setAction(unAzione);
            }// fine del blocco if

            /** modifica il testo del bottone
             * (nell'azione il testo avrebbe potuto essere diverso) */
            this.setText(TESTO);

            /** abilita il bottone
             * (l'azione avrebbe potuto non essere abilitata) */
...
//-------------------------------------------------------------------------
//-------------------------------------------------------------------------
}// fine della classe it.algos.base.componente.bottone.BottoneAnnulla.java
//-----------------------------------------------------------------------------
