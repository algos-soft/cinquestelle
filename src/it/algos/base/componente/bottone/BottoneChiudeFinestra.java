/**
 * Title:        BottoneChiudeFinestra.java
 ...
 * @version 1.0  /
 * Creato:       il 6 febbraio 2003 alle 9.50
 */
//-----------------------------------------------------------------------------
 ...
 * A - Costruire un bottone con comando di chiusura della finestra <br>
 *
 * @author Guido Andrea Ceresa & Alessandro Valbonesi  /  gac
 * @version 1.0  /  7 gennaio 2003 ore 9.50
 */
public class BottoneChiudeFinestra extends BottoneAstratto {
     ...
     */
    private static final String NOME_CLASSE = "BottoneChiudeFinestra";
    ...
    private void inizia() throws Exception {
        /** crea l'azione */
//        unAzioneOld = new AzioneChiudeFinestraOldOld();
        //@todo sostituire con azione
        this.setText("Continua");
        /** aggiunge il legame all'azione */
//	this.addActionListener(unAzioneOld.getAzione());
    ...
    //-------------------------------------------------------------------------
    //-------------------------------------------------------------------------
}// fine della classe it.algos.base.componente.bottone.BottoneChiudeFinestra.java
//-----------------------------------------------------------------------------
