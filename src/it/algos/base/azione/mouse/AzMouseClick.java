...
/**
 * Mouse cliccato una volta.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Intercetta il generico click del mouse </li>
 ...
 * @author gac
 * @version 1.0    / 7-gen-2005 ore 8.57.08
 */
public class AzMouseClick extends AzAdapterMouse {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.MOUSE_CLICK;
    ...
    public void mouseReleased(MouseEvent unEvento) {
        ...
        if (unEvento.getClickCount() == 1) {
            ...
            super.getGestore().mouseClick(unEvento, this);
        } /* fine del blocco if */
    }
