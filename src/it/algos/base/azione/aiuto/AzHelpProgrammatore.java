...
/**
 * Dialogo di help per il programmatore.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Apre un dialogo di help per il programmatore </li>
 ...
 * @author gac
 * @version 1.0    / 9-gen-2005 ore 8.13.13
 */
public final class AzHelpProgrammatore extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.HELP_PROGRAMMATORE;

    /**
     * Testo di default da mostrare
     * (obbligatorio per le azioni dei menu/bottoni/toolbar)
     */
    private static final String NOME = "Help programmatore...";
     ...
     */
    private static final String TESTO_TIP = "Help programmatore";

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String TESTO_HELP = "Apre un dialogo di help per il programmatore";
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().helpProgrammatore(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
