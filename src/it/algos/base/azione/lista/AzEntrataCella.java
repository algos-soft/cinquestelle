...
/**
 * Entrata nella cella di una Lista.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Intercetta l'entrata (focusGained) in una cella della Lista </li>
 ...
 * @author gac
 * @version 1.0    / 16-mar-2005 ore 6.47.31
 */
public final class AzEntrataCella extends AzAdapterFocus {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.ENTRATA_CELLA;
    ...
    public void focusGained(FocusEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().entrataCella(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
