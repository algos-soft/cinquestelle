...
/**
 * Si sposta avanti ed indietro di una schermata nella lista.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Intercetta l'inserimento di un carattere pagina </li>
 * <li> Controlla la pressione dei tasti pagina s&ugrave; e pagina gi&ugrave;
 * in una lista </li>
 ...
 * @author gac
 * @version 1.0    / 30-dic-2004 ore 9.40.36
 */
public final class AzPagine extends AzAdapterKey {

    /**
     * codifica dei caratteri da intercettare
     */
    private static final int giu = KeyEvent.VK_PAGE_DOWN;

    private static final int su = KeyEvent.VK_PAGE_UP;

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.PAGINE;
    ...
    private void inizia() throws Exception {
        ...
        super.addCarattere(giu);
        super.addCarattere(su);
    ...
    public void keyReleased(KeyEvent unEvento) {
        ...
        try { // prova ad eseguire il codice
            ...
            if (super.isCarattere(codice)) {
                ...
                super.getGestore().pagine(unEvento, this);
            } /* fine del blocco if */
