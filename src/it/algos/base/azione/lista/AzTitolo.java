...
/**
 * Mouse cliccato nel voce della lista.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Intercetta il click del mouse nei titoli della Lista </li>
 ...
 * @author gac
 * @version 1.0    / 6-gen-2005 ore 14.53.04
 */
public final class AzTitolo extends AzAdapterMouse {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.TITOLO;
    ...
    public void mouseReleased(MouseEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().titolo(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
