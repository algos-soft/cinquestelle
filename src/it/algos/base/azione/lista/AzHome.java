...
/**
 * Si sposta all'inizio della lista.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Intercetta l'inserimento di un carattere home </li>
 * <li> Controlla la pressione del tasto home in una lista </li>
 ...
 * @author gac
 * @version 1.0    / 30-dic-2004 ore 9.41.05
 */
public final class AzHome extends AzAdapterKey {

    /**
     * codifica dei caratteri da intercettare
     */
    private static final int home = KeyEvent.VK_HOME;

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.HOME;
    ...
    public void keyReleased(KeyEvent unEvento) {
        ...
        try { // prova ad eseguire il codice
            ...
            if (super.isCarattere(codice)) {
                ...
                super.getGestore().home(unEvento, this);
            } /* fine del blocco if */
