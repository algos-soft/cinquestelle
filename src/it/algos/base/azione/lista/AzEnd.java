...
/**
 * Si sposta alla fine della lista.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Intercetta l'inserimento di un carattere end </li>
 * <li> Controlla la pressione del tasto end in una lista </li>
 ...
 * @author gac
 * @version 1.0    / 30-dic-2004 ore 9.41.47
 */
public final class AzEnd extends AzAdapterKey {

    /**
     * codifica dei caratteri da intercettare
     */
    private static final int end = KeyEvent.VK_END;


    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.END;
    ...
    public void keyReleased(KeyEvent unEvento) {
        ...
        try { // prova ad eseguire il codice
            ...
            if (super.isCarattere(codice)) {
                ...
                super.getGestore().end(unEvento, this);
            } /* fine del blocco if */
