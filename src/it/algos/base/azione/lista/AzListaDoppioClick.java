...
/**
 * Mouse cliccato due volte nella lista.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Intercetta il doppio click del mouse nelle righe della Lista </li>
 ...
 * @author gac
 * @version 1.0    / 27-dic-2004 ore 21.58.47
 */
public final class AzListaDoppioClick extends AzAdapterMouse {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.LISTA_DOPPIO_CLICK;
    ...
    public void mouseReleased(MouseEvent unEvento) {
        ...
        if (unEvento.getClickCount() == 2) {
            ...
            super.getGestore().listaDoppioClick(unEvento, this);
        } /* fine del blocco if */
    }
