...
/**
 * Azione sposta un elemento verso sinistra.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Sposta l'elemento selezionato dalla lista di destra a quella di sinistra </li>
 ...
 * @version 1.0 / 3-4-05
 */
public final class AzImporta extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.IMPORT;

    /**
     * Testo di default da mostrare
     * (obbligatorio per le azioni dei menu/bottoni/toolbar)
     */
    private static final String NOME = "Importa";

    /**
     * Nome del disegno di default da mostrare
     * (consigliato per le azioni dei menu/bottoni/toolbar)
     */
    private static final String ICONA_PICCOLA = "frecciaDx16";

    private static final String ICONA_MEDIA = "frecciaDx24";

    private static final String ICONA_GRANDE = "frecciaDx";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TESTO_TIP = "Importa dati";

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String TESTO_HELP = "Importa dati";
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().importa(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
