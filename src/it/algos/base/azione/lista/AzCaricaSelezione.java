...
/**
 * Azione CaricaSelezione.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Carica dal database  la selezione della lista </li>
 ...
 * @version 1.0 / 3-4-05
 */
public final class AzCaricaSelezione extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.CARICA_SELEZIONE;

    /**
     * Testo di default da mostrare
     * (obbligatorio per le azioni dei menu/bottoni/toolbar)
     */
    private static final String NOME = "Carica la selezione...";
     ...
     */
    private static final String TESTO_TIP = "Carica la selezione";

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String TESTO_HELP = "Carica la selezione";
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().caricaSelezione(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
