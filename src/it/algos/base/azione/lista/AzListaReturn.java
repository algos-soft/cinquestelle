...
/**
 * Carattere Return in una lista.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Intercetta l'inserimento del carattere Return nella JTable </li>
 ...
 */
public final class AzListaReturn extends AzAdapterKey {

    /**
     * codifica dei caratteri da intercettare
     */
    private static final int ritorno = 13;


    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.LISTA_RETURN;
    ...
    public void keyReleased(KeyEvent unEvento) {
        ...
        try { // prova ad eseguire il codice
            ...
            if ((location == 1) && (codice == 10)) {
                /* invoca il metodo delegato della classe gestione eventi */
                super.getGestore().listaReturn(unEvento, this);
            } /* fine del blocco if */
