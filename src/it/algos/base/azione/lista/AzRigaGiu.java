 ...
 * @author alex
 * @version 1.0    / 22-dic-2004 ore 12.19.22
 */
public final class AzRigaGiu extends AzioneBase {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.RIGA_GIU;

    /**
     * Testo di default da mostrare (obbligatorio)
     */
    private static final String NOME = "Sposta in basso la riga";

    /**
     * Nome del disegno di default da mostrare (consigliato)
     */
    private static final String ICONA_PICCOLA = "listaspostagiu16";

    private static final String ICONA_MEDIA = "listaspostagiu24";

    private static final String ICONA_GRANDE = "listaspostagiu24";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TIP = "Sposta in basso la riga";

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String HELP = "Sposta verso il basso la riga selezionata";
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().rigaGiu(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    } // fine del metodo
