 ...
 * @author alex
 * @version 1.0    / 22-dic-2004 ore 12.09.32
 */
public final class AzSoloSelezionati extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.SOLO_SELEZIONATI;

    /**
     * Testo di default da mostrare (obbligatorio)
     */
    private static final String NOME = Testo.get(CostanteTesto.SOLO_SELEZIONATI);

    /**
     * Nome del disegno di default da mostrare (consigliato)
     */
    private static final String ICONA_PICCOLA = "SoloSelezionati16";

    private static final String ICONA_MEDIA = "SoloSelezionati24";

    private static final String ICONA_GRANDE = "SoloSelezionati";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TIP = Testo.get(CostanteTesto.SOLO_SELEZIONATI_TIP);

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String HELP = Testo.get(CostanteTesto.SOLO_SELEZIONATI_HELP);
     ...
     */
    private static final int MNEMONICO = KeyEvent.VK_ADD;
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().soloSelezionati(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    } // fine del metodo
