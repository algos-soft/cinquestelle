...
/**
 * Nasaconde i record selezionati.
 * <p/>
 ...
 * @author alex
 * @version 1.0    / 22-dic-2004 ore 12.10.53
 */
public final class AzNascondeSelezionati extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.NASCONDE_SELEZIONATI;

    /**
     * Testo di default da mostrare (obbligatorio)
     */
    private static final String NOME = Testo.get(CostanteTesto.NASCONDE_SELEZIONATI);

    /**
     * Nome del disegno di default da mostrare (consigliato)
     */
    private static final String ICONA_PICCOLA = "RimuoviSelezionati16";

    private static final String ICONA_MEDIA = "RimuoviSelezionati24";

    private static final String ICONA_GRANDE = "RimuoviSelezionati";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TIP = Testo.get(CostanteTesto.NASCONDE_SELEZIONATI_TIP);

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String HELP = Testo.get(CostanteTesto.NASCONDE_SELEZIONATI_HELP);
     ...
     */
    private static final int MNEMONICO = KeyEvent.VK_SUBTRACT;
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().nascondeSelezionati(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    } // fine del metodo
