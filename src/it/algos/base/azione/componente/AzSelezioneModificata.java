...
/**
 * Modificata la selezione del componente.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Intercetta la modifica della selezione di una lista </li>
 * <li> Implementa il metodo <code>valueChanged</code> della interfaccia
 * <code>ListSelectionListener</code> </li>
 * <li> Viene usata nei componenti della Scheda </li>
 * </ul>
 *
 * @author Guido Andrea Ceresa, Alessandro Valbonesi
 * @author gac
 * @version 1.0    / 6-gen-2005 ore 18.45.01
 */
public final class AzSelezioneModificata extends AzAdapterListSelection {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.SELEZIONE_MODIFICATA;
    ...
    public void valueChanged(ListSelectionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().selezioneModificata(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
