...
/**
 * Uscita da un campo popup.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Intercetta l'uscita da un popup di un ComboBox </li>
 * <li> Implementa il metodo <code>popupMenuWillBecomeInvisible</code> della interfaccia
 ...
 * @author gac
 * @version 1.0    / 6-gen-2005 ore 15.23.39
 */
public final class AzUscitaPopup extends AzAdapterPopupMenu {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.USCITA_POPUP;
    ...
    public void popupMenuWillBecomeInvisible(PopupMenuEvent unEvento) {
        try { // prova ad eseguire il codice
            if (super.getGestore() != null) {
                ...
                super.getGestore().uscitaPopup(unEvento, this);
            }// fine del blocco if
