...
/**
 * Chiusura del navigatore.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Chiude la finestra di un Navigatore </li>
 ...
 * @author gac
 * @version 1.0    / 20-dic-2004 ore 17.32.45
 */
public final class AzChiudeNavigatore extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.CHIUDE_NAVIGATORE;

    /**
     * Testo di default da mostrare (obbligatorio)
     */
    private static final String NOME = "Chiudi";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TIP = "Chiudi la finestra";

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String HELP = "Chiudi";

    /**
     * Nome del disegno di default da mostrare (consigliato)
     */
    private static final String ICONA_PICCOLA = "Stop16";

    private static final String ICONA_MEDIA = "Stop24";
     ...
     */
    private static final char ACCELERATORE = 'W';
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().chiudeNavigatore(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    } // fine del metodo
