...
/**
 * Registra i dati di Default per il modulo del navigatore.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Registra i dati di default per il modulo aprto al momento </li>
 ...
 * @author gac
 * @version 1.0    / 18-gen-2005 ore 22.38.40
 */
public final class AzRegistraDatiDefault extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.REGISTRA_DATI_DEFAULT;

    /**
     * Testo di default da mostrare
     * (obbligatorio per le azioni dei menu/bottoni/toolbar)
     */
    private static final String NOME = "Registra dati default";
     ...
     */
    private static final String TESTO_TIP = "";

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String TESTO_HELP = "";
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().registraDatiDefault(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
