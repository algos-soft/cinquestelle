 ...
 * <li> apre un dialogo di gestione gruppi ed utenti </li>
 ...
 * @version 1.0 / 3-4-05
 */
public final class AzUtenti extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.UTENTI;

    /**
     * Testo di default da mostrare
     * (obbligatorio per le azioni dei menu/bottoni/toolbar)
     */
    private static final String NOME = "Utenti e gruppi...";

    /**
     * Nome del disegno di default da mostrare
     * (consigliato per le azioni dei menu/bottoni/toolbar)
     */
    private static final String ICONA_PICCOLA = "Utenti16";

    private static final String ICONA_MEDIA = "Utenti24";

    private static final String ICONA_GRANDE = "Utenti";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TESTO_TIP = "Utenti";

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String TESTO_HELP = "Apre un dialogo di selezione utenti e gruppi";
