 ...
 */
public final class AzEscape extends AzAdapterKey {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.ESCAPE;
    ...
    private void inizia() throws Exception {
        ...
        super.addCarattere(Azione.Carattere.escape.getCodice());
    ...
    public void keyReleased(KeyEvent unEvento) {
        ...
        try { // prova ad eseguire il codice
            ...
            if (super.isCarattere(codice)) {
                ...
                super.getGestore().escape(unEvento, this);
            } /* fine del blocco if */
