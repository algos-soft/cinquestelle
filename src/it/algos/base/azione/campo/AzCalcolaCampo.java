 ...
 * <li> Sincronizza il testo di un campo calcolato che dipende dal componente
 ...
 * @author gac
 * @version 1.0    / 27-gen-2005 ore 17.37.44
 */
public final class AzCalcolaCampo extends AzCalcola {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.CALCOLA_CAMPO;
    ...
    public void keyReleased(KeyEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().calcolaCampo(unEvento, this, getCampoCalcolato());
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
