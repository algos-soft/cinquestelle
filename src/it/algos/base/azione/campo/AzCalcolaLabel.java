...
/**
 * Calcola la label di un campo.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Sincronizza la label di un campo calcolato che dipende dal componente
 * a cui &egrave; associata questa azione </li>
 * <li> Implementa il metodo <code>keyReleased</code> della interfaccia
 * <code>KeyListener</code> </li>
 * <li> Viene usata nei componenti della GUI </li>
 * </ul>
 *
 * @author Guido Andrea Ceresa, Alessandro Valbonesi
 * @author gac
 * @version 1.0    / 30-gen-2005 ore 18.48.36
 */
public final class AzCalcolaLabel extends AzCalcola {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.CALCOLA_LEGENDA;
    ...
    public void keyReleased(KeyEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().calcolaLabel(unEvento, this, getCampoCalcolato());
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
