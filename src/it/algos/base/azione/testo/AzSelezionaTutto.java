 ...
 * <li> Seleziona tutti gli oggetti </li>
 ...
 * @author gac
 * @version 1.0    / 7-gen-2005 ore 9.48.53
 */
public final class AzSelezionaTutto extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.SELEZIONA_TUTTO;

    /**
     * Testo di default da mostrare
     * (obbligatorio per le azioni dei menu/bottoni/toolbar)
     */
    private static final String NOME = Testo.get(CostanteTesto.SELEZIONA_TUTTO);

    /**
     * Nome del disegno di default da mostrare
     * (consigliato per le azioni dei menu/bottoni/toolbar)
     */
    private static final String ICONA_PICCOLA = "AlignJustify16";

    private static final String ICONA_MEDIA = "AlignJustify24";

    private static final String ICONA_GRANDE = "AlignJustify";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TESTO_TIP = Testo.get(CostanteTesto.SELEZIONA_TUTTO_TIP);

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String TESTO_HELP = Testo.get(CostanteTesto.SELEZIONA_TUTTO_HELP);

    /**
     * Carattere del tasto acceleratore (facoltativo)
     */
    private static final char ACCELERATORE = 'A';
...
//            super.getGestore().selezionaTutto(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
