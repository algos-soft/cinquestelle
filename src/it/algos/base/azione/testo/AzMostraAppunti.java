 ...
 * <li> Mostra il testo contenuto negli appunti </li>
 ...
 * @author gac
 * @version 1.0    / 7-gen-2005 ore 9.47.45
 */
public final class AzMostraAppunti extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.MOSTRA_APPUNTI;

    /**
     * Testo di default da mostrare
     * (obbligatorio per le azioni dei menu/bottoni/toolbar)
     */
    private static final String NOME = Testo.get(CostanteTesto.MOSTRA_APPUNTI);

    /**
     * Nome del disegno di default da mostrare
     * (consigliato per le azioni dei menu/bottoni/toolbar)
     */
    private static final String ICONA_PICCOLA = "Open16";

    private static final String ICONA_MEDIA = "Open24";

    private static final String ICONA_GRANDE = "Open";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TESTO_TIP = Testo.get(CostanteTesto.MOSTRA_APPUNTI_TIP);

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String TESTO_HELP = Testo.get(CostanteTesto.MOSTRA_APPUNTI_HELP);
...
//            super.getGestore().mostraAppunti(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
