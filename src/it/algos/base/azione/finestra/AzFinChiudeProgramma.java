 ...
 * @author gac
 * @version 1.0    / 7-gen-2005 ore 7.48.17
 */
public final class AzFinChiudeProgramma extends AzAdapterWindow {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.FINESTRA_CHIUDE_PROGRAMMA;
