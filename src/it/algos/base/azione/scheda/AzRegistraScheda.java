 ...
 * <li> Registra le modifiche apportate alla scheda </li>
 ...
 * @author alex
 * @version 1.0    / 22-dic-2004 ore 12.24.14
 */
public final class AzRegistraScheda extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.REGISTRA_SCHEDA;

    /**
     * Testo di default da mostrare (obbligatorio)
     */
    private static final String NOME = Testo.get(CostanteTesto.REGISTRA);

    /**
     * Nome del disegno di default da mostrare (consigliato)
     */
    private static final String ICONA_PICCOLA = "Registra16";

    private static final String ICONA_MEDIA = "Registra24";

    private static final String ICONA_GRANDE = "Registra";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TIP = Testo.get(CostanteTesto.REGISTRA_TIP);

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String HELP = Testo.get(CostanteTesto.REGISTRA_HELP);

    /**
     * Carattere del tasto acceleratore (facoltativo)
     */
    private static final char ACCELERATORE = 'S';

    /**
     * codice carattere di default per il tasto mnemonico (facoltativo)
     */
    private static final int MNEMONICO = KeyEvent.VK_ENTER;
    ...
    public void actionPerformed(ActionEvent unEvento) {
        ...
        try { // prova ad eseguire il codice
            ...
            String stringa = unEvento.getActionCommand();
            int id = unEvento.getID();
            int mod = unEvento.getModifiers();
