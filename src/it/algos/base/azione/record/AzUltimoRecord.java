 ...
 * <li> Carica nella scheda l'ultimo record della lista </li>
 ...
 * @author alex
 * @version 1.0    / 22-dic-2004 ore 12.18.42
 */
public final class AzUltimoRecord extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.ULTIMO_RECORD;

    /**
     * Testo di default da mostrare (obbligatorio)
     */
    private static final String NOME = Testo.get(CostanteTesto.ULTIMO_RECORD);

    /**
     * Nome del disegno di default da mostrare (consigliato)
     */
    private static final String ICONA_PICCOLA = "Ultimo16";

    private static final String ICONA_MEDIA = "Ultimo24";

    private static final String ICONA_GRANDE = "Ultimo";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TIP = Testo.get(CostanteTesto.ULTIMO_RECORD_TIP);

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String HELP = Testo.get(CostanteTesto.ULTIMO_RECORD_HELP);
     ...
     */
    private static final int MNEMONICO = KeyEvent.VK_DOWN;
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().ultimoRecord(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    } // fine del metodo
