...
/**
 * Spostamento al record precedente.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Carica nella scheda il record precedente della lista </li>
 ...
 * @author alex
 * @version 1.0    / 22-dic-2004 ore 12.16.11
 */
public final class AzRecordPrecedente extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.RECORD_PRECEDENTE;

    /**
     * Testo di default da mostrare (obbligatorio)
     */
    private static final String NOME = Testo.get(CostanteTesto.RECORD_PRECEDENTE);

    /**
     * Nome del disegno di default da mostrare (consigliato)
     */
    private static final String ICONA_PICCOLA = "Precedente16";

    private static final String ICONA_MEDIA = "Precedente24";

    private static final String ICONA_GRANDE = "Precedente";

    /**
     * Descrizione di default per il tooltiptext (facoltativo)
     */
    private static final String TIP = Testo.get(CostanteTesto.RECORD_PRECEDENTE_TIP);

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String HELP = Testo.get(CostanteTesto.RECORD_PRECEDENTE_HELP);
     ...
     */
    private static final int MNEMONICO = KeyEvent.VK_LEFT;
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().recordPrecedente(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    } // fine del metodo
