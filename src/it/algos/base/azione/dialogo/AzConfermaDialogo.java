...
/**
 * Conferma di un Dialogo.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Conferma e chiude il <code>Dialogo</code> </li>
 * <li> Implementa il metodo <code>actionPerformed</code> della interfaccia
 * <code>ActionListener</code> </li>
 * <li> Viene usata nei dialoghi </li>
 * </ul>
 *
 * @author Guido Andrea Ceresa, Alessandro Valbonesi
 * @author alex
 * @version 1.0    / 22-dic-2004 ore 14.21.47
 */
public final class AzConfermaDialogo extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.CONFERMA_DIALOGO;

    /**
     * Testo di default da mostrare (obbligatorio)
     */
    private static final String NOME = "Conferma";
     ...
     */
    private static final String TIP = "Conferma il dialogo";

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String HELP = "Conferma il dialogo";
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().confermaDialogo(unEvento, this);
