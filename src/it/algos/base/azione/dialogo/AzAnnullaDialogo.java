...
/**
 * Annullamento di un Dialogo.
 * <p/>
 * Questa classe azione concreta: <ul>
 * <li> Annulla e chiude il <code>Dialogo</code> </li>
 ...
 * @author alex
 * @version 1.0    / 22-dic-2004 ore 14.19.50
 */
public final class AzAnnullaDialogo extends AzAdapterAction {

    /**
     * Testo della chiave per recuperare l'azione (obbligatorio)
     */
    private static final String CHIAVE = Azione.ANNULLA_DIALOGO;

    /**
     * Testo di default da mostrare (obbligatorio)
     */
    private static final String NOME = "Annulla";
     ...
     */
    private static final String TIP = "Annulla il dialogo";

    /**
     * Descrizione di default per l'aiuto in linea (facoltativo)
     */
    private static final String HELP = "Annulla il dialogo";
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            ...
            super.getGestore().annullaDialogo(unEvento, this);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    } // fine del metodo
