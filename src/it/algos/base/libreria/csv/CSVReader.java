package it.algos.base.libreria.csv;
            ...
            for (int i = 0; i < nextLine.length(); i++) {
                ...
                if (c == quotechar) {
                    ...
                    if (inQuotes
                            ...
                            && nextLine.charAt(i + 1) ==
                            quotechar) { // ..and that char. is a quote also.
                        ...
                        if (i > 2
                                //not on the begining of the line
                                && nextLine.charAt(i - 1) != this.separator
                                //not at the begining of an escape sequence
                                && nextLine.length() > (i + 1) && nextLine.charAt(i + 1) != this
                                .separator //not at the	end of an escape sequence
                                ) {
                            sb.append(c);
                        }
                    }
