...
public class JDatePanel extends JPanel {
    ...
    public Date getDate() {
        ...
        try {    // prova ad eseguire il codice
            data = this.getCalenderModel().getCalendar().getTime();
            data = Lib.Data.dropTime(data);
    ...
    public void setDate(Date data) {
        this.getCalenderModel().setCalendar(data);
    }
    ...
    private class CalendarTableCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(
            ...
            JLabel label = (JLabel)super.getTableCellRendererComponent(
                    arg0, arg1, isSelected, hasFocus, row, col);
    ...
    private class GregorianCalendarModel implements TableModel, SpinnerModel {
        ...
        public void addTodayLabel(JLabel label) {
            ...
            label.setText("Oggi: " + df1.format(new Date()));
        }
    ...
    public static void main(String[] args) {
        ...
        testFrame.addWindowFocusListener(
                new WindowAdapter() {
    ...
    private void fireActionPerformed() {
        ...
        while (i.hasNext()) {
            ...
            al.actionPerformed(
                    new ActionEvent(
                            this, ActionEvent.ACTION_PERFORMED, "date selected"));
        }
    }
    ...
    public GregorianCalendarModel getCalenderModel() {
