package it.algos.base.util.jdatepicker;
...
public class JDatePicker extends JPanel {
     ...
     */
    public Date getDate() {
        return this.getDatePanel().getDate();
    }
    ...
    public void setDate(Date data) {
        this.getDatePanel().setDate(data);
    }


    /**
     * Registra un listener per le modifiche alla data selezionata.
     * <p/>
     * @param listener ChangeListener da aggiungere
     */
    public void addChangeListener (ChangeListener listener) {
        this.getDatePanel().addChangeListener(listener);
    }
...
//        int w = (int)datePanel.getPreferredSize().getWidth();
    ...
    private void showPopup() {
        if (popup == null) {
            ...
            popup = fac.getPopup(
                    this, datePanel, (int)xy.getX(), (int)(xy.getY() + this.getHeight() - 1));
            popup.show();
        }
    }
    ...
    public JDatePanel getDatePanel() {
        return datePanel;
    }


    private void setDatePanel(JDatePanel datePanel) {
