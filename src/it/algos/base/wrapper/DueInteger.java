 ...
 */
public final class DueInteger extends Object {
     ...
     */
    public DueInteger(Integer x, Integer y) {
     ...
     * per i campi x e y (anche valori nulli)
     *
    ...
    public boolean equals(Object altroOggetto) {
        ...
        if (!(altroOggetto instanceof DueInteger)) {
            return false; // tipi non comparabili
        }

        //* procedo alla comparazione */
        boolean uguali = false;
        DueInteger questo = this;
        DueInteger altro = (DueInteger)altroOggetto;
