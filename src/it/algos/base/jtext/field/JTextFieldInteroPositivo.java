/**
 * Title:        JTextFieldInteroPositivo.java
...
import it.algos.base.filtro.FiltroInteroPositivo;
 ...
 * A - Gestire un campo di numeri interi positivi <br>
 * B - Crea un riferimento alla classe filtroOld <code>FiltroInteroPositivo</code> <br>
 * C - Sovrascrive il metodo <code>creaDefaulModel</code> <br>
 *
 * @author Guido Andrea Ceresa & Alessandro Valbonesi  /  gac
 * @version 1.0  /  24 gennaio 2003 ore 10.37
 */
public final class JTextFieldInteroPositivo extends JTextFieldAlgos {
     ...
     */
    private static final String NOME_CLASSE = "JTextFieldInteroPositivo";
     ...
     */
    public JTextFieldInteroPositivo() {
     ...
     */
    public JTextFieldInteroPositivo(Campo unCampo) {
        /** rimanda al costruttore di questa classe */
     ...
     */
    public JTextFieldInteroPositivo(Campo unCampo, int caratteriMassimi) {
        /** rimanda al costruttore della superclasse */
        super(unCampo);

        /** regola le variabili di istanza coi parametri */
        super.caratteriMassimi = caratteriMassimi;
        setCaratteriMassimi(caratteriMassimi);
    ...
    protected Document createDefaultModel() {
        return new FiltroInteroPositivo(caratteriMassimi);
    } /* fine del metodo */
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    //-------------------------------------------------------------------------
}// fine della classe it.algos.base.jtext.field.JTextFieldInteroPositivo.java
//-----------------------------------------------------------------------------
