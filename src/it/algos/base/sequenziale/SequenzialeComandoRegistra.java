/**
 * Title:        SequenzialeComandoRegistra.java
 ...
 */
public class SequenzialeComandoRegistra extends SequenzialeComandoBase implements ActionListener {
     ...
     */
    private static final String NOMECLASSE = "SequenzialeComandoRegistra";

    /**
     * testo del bottone
     */
    private static final String TESTO = "Registra";
     ...
     */
    public SequenzialeComandoRegistra() {
     ...
     */
    public SequenzialeComandoRegistra(SequenzialeGestore unGestore) {
    ...
    //-------------------------------------------------------------------------
    //-------------------------------------------------------------------------
}// fine della classe it.algos.base.sequenziale.SequenzialeComandoRegistra.java
//-----------------------------------------------------------------------------
