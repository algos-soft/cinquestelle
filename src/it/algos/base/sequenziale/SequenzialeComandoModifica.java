/**
 * Title:        SequenzialeComandoModifica.java
 ...
 */
public class SequenzialeComandoModifica extends SequenzialeComandoBase implements KeyListener {
     ...
     */
    private static final String NOMECLASSE = "SequenzialeComandoModifica";

    /**
     * testo del bottone
     */
    private static final String TESTO = "Modifica";
     ...
     */
    public SequenzialeComandoModifica() {
     ...
     */
    public SequenzialeComandoModifica(SequenzialeGestore unGestore) {
    ...
    //-------------------------------------------------------------------------
    /**
     * keyPressed, da KeyListener.<br>
     * Esegue il comando - Campo modificato
    ...
    public void keyPressed(KeyEvent unEvento) {
        /** controllo per 'passare' solo i caratteri */
        if ((unEvento.getKeyChar() > 32) & (unEvento.getKeyChar() < 127)) {
            unGestore.comandoModifica();
        } // fine di if
    } // keyPressed


    /**
     * keyTyped, da KeyListener.<br>
     * Esegue il comando -
     * Rimanda ai metodi della classe che gestisce i comandi
     *
     * @param unEvento - L' evento che causa il comando da eseguire
    ...
    //-------------------------------------------------------------------------
    //-------------------------------------------------------------------------
}// fine della classe it.algos.base.sequenziale.SequenzialeComandoModifica.java
//-----------------------------------------------------------------------------
