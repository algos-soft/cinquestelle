/**
 * Title:        SequenzialeComandoElimina.java
 ...
 */
public class SequenzialeComandoElimina extends SequenzialeComandoBase implements ActionListener {
     ...
     */
    private static final String NOMECLASSE = "SequenzialeComandoElimina";

    /**
     * testo del bottone
     */
    private static final String TESTO = "Elimina";
     ...
     */
    public SequenzialeComandoElimina() {
     ...
     */
    public SequenzialeComandoElimina(SequenzialeGestore unGestore) {
    ...
    //-------------------------------------------------------------------------
    //-------------------------------------------------------------------------
}// fine della classe it.algos.base.sequenziale.SequenzialeComandoElimina.java
//-----------------------------------------------------------------------------
