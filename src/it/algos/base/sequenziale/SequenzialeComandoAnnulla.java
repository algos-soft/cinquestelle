/**
 * Title:        SequenzialeComandoAnnulla.java
 ...
 */
public class SequenzialeComandoAnnulla extends SequenzialeComandoBase implements ActionListener {
     ...
     */
    private static final String NOMECLASSE = "SequenzialeComandoAnnulla";

    /**
     * testo del bottone
     */
    private static final String TESTO = "Annulla";
     ...
     */
    public SequenzialeComandoAnnulla() {
     ...
     */
    public SequenzialeComandoAnnulla(SequenzialeGestore unGestore) {
    ...
    //-------------------------------------------------------------------------
    //-------------------------------------------------------------------------
}// fine della classe it.algos.base.sequenziale.SequenzialeComandoAnnulla.java
//-----------------------------------------------------------------------------
