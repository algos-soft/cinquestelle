 ...
 */
public final class ENuovo extends EBase {
     ...
     */
    private static final String ICONA = "Nuovo16";

    /**
     * testo che viene mostrato nel popup da questo elemento (riga)
     */
    private static final String TESTO = "Nuovo valore ...";
    ...
    //-------------------------------------------------------------------------
    //-------------------------------------------------------------------------
}// fine della classe it.algos.base.campo.elemento.ENuovo.java
//-----------------------------------------------------------------------------
