 ...
 */
public final class TMTimestamp extends TMBase implements TipoMemoria {


    /**
     * istanza unica di questa classe, creata ad avvio del programma
     */
    private final static TMTimestamp ISTANZA = new TMTimestamp();
    ...
    private void inizia() throws Exception {
        this.setClasse(Timestamp.class);
        super.setValoreVuoto(new Timestamp(0));
    ...
    private boolean isModificatoSpecifico(Campo unCampo) {
        ...
        Timestamp unValoreMemoria ;
        Timestamp unValoreBackup ;
        ...
        unValoreMemoria = (Timestamp)unOggettoMemoria;
        unValoreBackup = (Timestamp)unOggettoBackup;
        if (unValoreMemoria.getNanos() != unValoreBackup.getNanos()) {
            modificato = true;
        } /* fine del blocco if */
     ...
     */
    public static TMTimestamp getIstanza() {
        return ISTANZA;
