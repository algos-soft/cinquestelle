 ...
 */
public final class TVIntero extends TVBase {
     ...
     */
    private final static TVIntero ISTANZA = new TVIntero();
    ...
    private void inizia() throws Exception {
        this.setClasse(new Integer(0).getClass());
     ...
     */
    public static TVIntero getIstanza() {
        return ISTANZA;
