...
/**
 * Componente video di tipo data.
 * </p>
 *
 * @author Guido Andrea Ceresa & Alessandro Valbonesi  /  gac
 * @version 1.0  /  3 luglio 2003 ore 23.53
 */
public final class CVData extends CVTestoField {
     ...
     */
    public CVData(Campo unCampoParente) {
    ...
    private void inizia() throws Exception {
        ...
        this.getCampoParente().setLarScheda(80); // @todo non funziona e non serve a niente
