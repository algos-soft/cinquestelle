 ...
 */
public class CVNumero extends CVTestoField {
     ...
     */
    public CVNumero(Campo unCampoParente) {
    ...
    private void inizia() throws Exception {
        ...
        this.getCampoParente().setLarScheda(50);

        this.setAllineamento(SwingConstants.RIGHT);
