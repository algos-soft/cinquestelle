...
//        return creaFiltro(new SimpleDateFormat("dd-MM-yyyy"), new SimpleDateFormat("EEEE, dd MMM yyyy"));
        return creaFiltro(new SimpleDateFormat("dd-MM-yyyy"), new SimpleDateFormat("dd-MM-yyyy"));
    }
