...
import it.algos.base.filtroAlb.FiltriUscitaFactory;
import it.algos.base.filtroAlb.FiltroUscita;
...
public class Test extends javax.swing.JFrame {
    ...
    private void inizializza() {
        ...
        cp.add(FiltroIngressoFactory.creaCodiceFiscale());
        cp.add(new JLabel("Et\u00e0"));
        JTextField decTf = new JTextField();
        decTf.addKeyListener(FiltroIngressoFactory.creaDecimali());
        cp.add(decTf);
        cp.add(new JLabel("Data"));
        cp.add(FiltroIngressoFactory.creaFiltroData());
