 ...
 * A - Filtrare solo i numeri interi positivi <br>
 * B - Intero = solo cifre <br>
 *
 * @author Guido Andrea Ceresa & Alessandro Valbonesi  /  gac
 * @version 1.0  /  24 gennaio 2003 ore 7.04
 */
public final class FiltroInteroPositivo extends FiltroAlgos implements CostanteCarattere {
     ...
     */
    private static final String NOME_CLASSE = "FiltroInteroPositivo";
     ...
     */
    public FiltroInteroPositivo(int maxCifre) {
    ...
    //-------------------------------------------------------------------------
    //-------------------------------------------------------------------------
}// fine della classe it.algos.base.filtroOld.FiltroInteroPositivo.java
//-----------------------------------------------------------------------------