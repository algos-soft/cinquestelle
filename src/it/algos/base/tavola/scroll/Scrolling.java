...
/**
 * Implementazione delle funzionalita' di scrolling per un componente.
 * </p>
 *
...
public abstract class Scrolling {
    ...
    public static final int VIEWPORT = 0,       // take the policy of the viewport
            ...
            UNCHANGED =
                    1,      // don't scroll if it fills the visible area, otherwise take the policy of the viewport
    ...
    public static final int NONE = 0, TOP = 1, VCENTER = 2, BOTTOM = 4, LEFT = 8, HCENTER =
            16, RIGHT = 32;
