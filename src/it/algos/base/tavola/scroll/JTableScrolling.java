/**
 * Title:     JTableScrolling
 * Copyright: Copyright (c) 2004
 * Company:   C) 2001-2004 Christian Kaufhold
 * Author:    alex
 * Date:      23-set-2004
 */
package it.algos.base.tavola.scroll;

import javax.swing.*;
import java.awt.*;

/**
 * Implementazione delle funzionalita' di scrolling per una JTable.
 * </p>
 *
...
public abstract class JTableScrolling {
    ...
    public static Rectangle getCellBounds(JTable table,
                                          int firstRow,
                                          int lastRow,
                                          int firstColumn,
                                          int lastColumn) {
    ...
    public static void makeCellsVisible(JTable table,
                                        int firstRow,
                                        int lastRow,
                                        int firstColumn,
                                        int lastColumn) {
    ...
    public static void makeCellsVisible(JTable table,
                                        ...
                                        int lastColumn,
                                        int bias) {
        Scrolling.scroll(table,
                getCellBounds(table, firstRow, lastRow, firstColumn, lastColumn),
                bias);
    }
    ...
    public static boolean areCellsVisible(JTable table,
                                          int firstRow,
                                          int lastRow,
                                          int firstColumn,
                                          int lastColumn) {
    ...
    private static void checkCells(JTable table,
                                   int firstRow,
                                   int lastRow,
                                   int firstColumn,
                                   int lastColumn) {
