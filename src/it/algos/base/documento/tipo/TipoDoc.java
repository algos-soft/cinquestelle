 ...
 */
public interface TipoDoc extends Generale {
     ...
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "tipidocumento";

    /**
     * Codifica del voce della finestra
     * (usato nel Navigatore)
     */
    public static final String TITOLO_FINESTRA = "Tipi di documento";

    /**
     * Codifica del voce del modulo come appare nel Menu Moduli
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Tipi di documento";
