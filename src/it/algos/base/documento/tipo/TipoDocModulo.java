...
package it.algos.base.documento.tipo;
...
/**
 * Documento - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 */
public final class TipoDocModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = TipoDoc.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = TipoDoc.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = TipoDoc.TITOLO_MENU;
     ...
     */
    public TipoDocModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new TipoDocModello());
    ...
    public int getNextNumero(String chiave) {
        ...
        try { // prova ad eseguire il codice
            filtro = FiltroFactory.crea(TipoDoc.Cam.chiave.get(), chiave);
            lista = this.query().valoriCampo(TipoDoc.Cam.ultimoNumero.get(), filtro);
    ...
    public boolean setUltNumero(String chiave, int numero) {
        ...
        try {    // prova ad eseguire il codice
            ...
            campo = this.getCampo(TipoDoc.Cam.ultimoNumero.get());
     ...
     */
    public static TipoDocModulo get() {
        return (TipoDocModulo)ModuloBase.get(NOME_CHIAVE);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new TipoDocModulo();
