...
/**
 * Interfaccia del pacchetto Incrocio Composizioni Camera - Accessori
 * </p>
 ...
 */
public interface CompoAccessori {

    /**
     * Codifica del nome-chiave interno del modulo
     */
    public static final String NOME_MODULO = "CompoAccessori";

    /**
     * Codifica della tavola di archivio collegata
     */
    public static final String NOME_TAVOLA = "compoaccessori";

    /**
     * Codifica del titolo della finestra
     */
    public static final String TITOLO_FINESTRA = "Composizioni - Accessori";

    /**
     * Codifica del titolo del modulo come appare nel Menu Moduli
     */
    public static final String TITOLO_MENU = "Composizioni - Accessori";
    ...
    public enum Cam implements Campi {
        ...
        composizione("linkcomposizione", "composizione", "composizione", "", true),
        accessorio("linkaccessorio", "accessorio", "accessorio", "", true),
        quantita("quantita", "quantità", "quantità", "", true);
    ...
    public enum Vis {
        ...
        visInComposizione(); // vista usata nel nav interno alla scheda Composizione Camera
    ...
    public enum Nav implements Navigatori {
        ...
        mioNav(),
        navInComposizione();   // navigatore degli accessori nella scheda Composizione Camera
