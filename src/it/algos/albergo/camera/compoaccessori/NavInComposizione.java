...
/**
 * Navigatore nella scheda Composizione Camera
 * </p>
 * Questa classe: <ul>
 * <li> </li>
 * <li> </li>
 ...
 * @author alex
 * @version 1.0    / 22-giu-2009 ore 22.46.59
 */
public final class NavInComposizione extends NavigatoreLS {
     ...
     */
    public NavInComposizione(Modulo unModulo) {
    ...
    private void inizia() throws Exception {
        ...
        this.setNomeChiave(CompoAccessori.Nav.navInComposizione.get());
        this.setUsaPannelloUnico(true);
        this.getLista().setOrdinabile(false);
        this.setNomeVista(CompoAccessori.Vis.visInComposizione.get());
        this.addSchedaCorrente(new CompoAccessoriScheda(this.getModulo()));
