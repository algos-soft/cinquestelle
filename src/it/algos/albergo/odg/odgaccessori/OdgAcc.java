...
/**
 * Interfaccia del pacchetto Accessori Righe ODG
 * Tavola di incrocio tra Righe ODG <-> Accessori camera
 * </p>
 ...
 */
public interface OdgAcc {

    /**
     * Codifica del nome-chiave interno del modulo
     */
    public static final String NOME_MODULO = "OdgAccessori";

    /**
     * Codifica della tavola di archivio collegata
     */
    public static final String NOME_TAVOLA = "odgaccessori";

    /**
     * Codifica del titolo della finestra
     */
    public static final String TITOLO_FINESTRA = "Accessori righe ODG";

    /**
     * Codifica del titolo del modulo come appare nel Menu Moduli
     */
    public static final String TITOLO_MENU = "Accessori righe ODG";
    ...
    public enum Cam implements Campi {
        ...
        rigaOdg("linkrigaodg", "riga odg", "riga odg", "", false),
        accessorio("linkaccessorio", "accessorio", "accessorio", "", true),
        quantita("quantita", "quantità", "quantità", "", false);
    ...
    public enum Vis {
        ...
        visInRigaOdg(); // vista usata nel Navigatore dentro alla scheda Righe Odg
    ...
    public enum Nav implements Navigatori {
        ...
        navInRigheOdg();  // navigatore nelle righe di ODG
