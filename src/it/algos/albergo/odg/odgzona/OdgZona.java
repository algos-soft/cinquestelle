...
/**
 * Interfaccia del pacchetto Zone di un ODG
 * </p>
 ...
 */
public interface OdgZona {

    /**
     * Codifica del nome-chiave interno del modulo
     */
    public static final String NOME_MODULO = "OdgZona";

    /**
     * Codifica della tavola di archivio collegata
     */
    public static final String NOME_TAVOLA = "odgzone";

    /**
     * Codifica del titolo della finestra
     */
    public static final String TITOLO_FINESTRA = "Zone Ordine del Giorno";

    /**
     * Codifica del titolo del modulo come appare nel Menu Moduli
     */
    public static final String TITOLO_MENU = "Zone Ordine del Giorno";
    ...
    public enum Vis {
        ...
        vistaZone(); // vista usata nel Navigatore ZoneNavigatore
