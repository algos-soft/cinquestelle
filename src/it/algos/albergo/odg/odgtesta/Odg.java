...
/**
 * Interfaccia del pacchetto Odg - Ordine del Giorno
 * </p>
...
public interface Odg {
     ...
     */
    public static final String NOME_MODULO = "Odg";

    /**
     * Codifica della tavola di archivio collegata
     */
    public static final String NOME_TAVOLA = "odg";

    /**
     * Codifica del titolo della finestra
     */
    public static final String TITOLO_FINESTRA = "Ordine del Giorno";

    /**
     * Codifica del titolo del modulo come appare nel Menu Moduli
     */
    public static final String TITOLO_MENU = "Ordine del Giorno";
