...
public interface Risorsa {
     ...
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "Risorsa";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "risorse";
     ...
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Risorse";
    ...
    /**
     * Colore di default per le celle della barra delle risorse nel tableau
     */
    ...
    public enum Cam implements Campi {
        ...
        numero("", "Numero", "Numero", "", true),
        note("", "Note", "Note", "", true),
        tipo("linkTipo", "Tipo", "Tipo", "", true),
        colore("colore", "Colore", "Colore", "", false);
