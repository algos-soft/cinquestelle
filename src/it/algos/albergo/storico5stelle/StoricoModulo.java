...
/**
 * Storico - dati storici delle presenze importati da 5Stelle.
 * <p/>
 *
 ...
 */
public final class StoricoModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = Storico.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = Storico.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = Storico.TITOLO_MENU;
     ...
     */
    public StoricoModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        try { // prova ad eseguire il codice
            ...
            super.setModello(new StoricoModello());
    ...
    protected void creaNavigatori() {
        ...
        try { // prova ad eseguire il codice
            ...
            nav = new StoricoNavigatore(this);
...
//            super.addModuloVisibile(CompoCamera.NOME_MODULO);
     ...
     */
    public static StoricoModulo get() {
        return (StoricoModulo)ModuloBase.get(StoricoModulo.NOME_CHIAVE);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new StoricoModulo();
