 ...
 * @version 1.0 / 3-4-05
 */
public interface TestaStampe extends Generale {

    /**
     * Codifica del nome-chiave interno del modulo
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "TestaStampe";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "testastampe";

    /**
     * Codifica del voce della finestra
     * (usato nel Navigatore)
     */
    public static final String TITOLO_FINESTRA = "TestaStampe";

    /**
     * Codifica del voce del modulo come appare nel Menu Moduli
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "TestaStampe";
    ...
    public enum Cam implements Campi {
        ...
        data("arrivo", "data", "data", "data", true),
        stampato("stampato", "stampa", "", "", true),
        gruppi("gruppi", "grup", "", "", true),
        numArrivati("persone", "arr", "", "", true),
        presPrec("presprec", "g prec", "", "", true),
        numPartiti("numpartiti", "part", "", "", true),
        progressivo("progressivo", "#", "", "", true);
    ...
    /**
     * Codifica dei modelli testa-riga associabili.
     */
    public enum TipoRegistro {
        ...
        /**
         * codice registrato nel database.
         * <p/>
         * default il nome della Enumeration <br>
         */
        private int codice;
