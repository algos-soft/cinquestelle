 ...
 * @version 1.0 / 3-4-05
 */
public interface Ps extends Generale {

    /**
     * Codifica del nome-chiave interno del modulo
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "PubblicaSicurezza";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "pubblicasicurezza";

    /**
     * Codifica del voce della finestra
     * (usato nel Navigatore)
     */
    public static final String TITOLO_FINESTRA = "PubblicaSicurezza";

    /**
     * Codifica del voce del modulo come appare nel Menu Moduli
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "PubblicaSicurezza";
    ...
    public enum Cam implements Campi {
        ...
        progressivo("progressivo", "#", "progressivo", "progressivo da inizio anno", true),
        linkCliente("linkcliente", "cliente", "cliente", "", true),
        linkPresenza("linkpresenza","","","",false),
