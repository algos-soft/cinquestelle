...
public interface TipoRisorsa {
     ...
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "TipoRisorsa";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "tipi_risorsa";
     ...
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Tipi risorsa";
    ...
    public enum Cam implements Campi {
        ...
        sigla("", "Risorsa", "Sigla", "", true),
        settore("", "Settore", "Settore", "", true);
