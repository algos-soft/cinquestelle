...
package it.algos.albergo.tabelle.operatore;
...
/**
 * Operatore - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 */
public final class OperatoreModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = Operatore.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = Operatore.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = Operatore.TITOLO_MENU;
     ...
     */
    public OperatoreModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new OperatoreModello());
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new OperatoreModulo();
