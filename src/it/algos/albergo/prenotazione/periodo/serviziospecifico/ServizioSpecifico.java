 ...
 */
public interface ServizioSpecifico {

    /**
     * Codifica del nome-chiave interno del modulo
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "ServizioSpecifico";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "servizispecifici";
     ...
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Servizi specifici";
