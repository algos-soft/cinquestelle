...
public interface RisorsaPeriodo {

    /**
     * Codifica del nome-chiave interno del modulo
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "RisorsaPeriodo";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "risorseperiodo";
     ...
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "RisorsePeriodo";
    ...
    public enum Cam implements Campi {
        ...
        periodo("linkperiodo", "periodo", "periodo", "", true),
        risorsa("linkrisorsa", "numero", "numero", "", true),
        tipoRisorsa("linktiporisorsa", "tipo", "tipo", "", true),
        dataInizio("data1", "dal", "dal", "", true),
        dataFine("data2", "al", "al", "", true),
        note("note", "", "", "", true);
