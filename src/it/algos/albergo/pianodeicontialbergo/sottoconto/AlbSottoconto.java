 ...
 */
public interface AlbSottoconto extends Generale {

    /**
     * Codifica del nome-chiave interno del modulo
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "AlbSottoconto";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "albsottoconto";

    /**
     * Codifica del titolo della finestra
     * (usato nel Navigatore)
     */
    public static final String TITOLO_FINESTRA = "Sottoconto";

    /**
     * Codifica del titolo del modulo come appare nel Menu Moduli
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Sottoconto";
     ...
     * <p/>
     * Vista per il navigatore all'interno del conto (piano dei conti)
     * <p/>
     * Vista per il navigatore all'interno del conto (piano dei conti)
     * <p/>
     * Vista per il navigatore all'interno del conto (piano dei conti)
     ...
     * Vista per il navigatore all'interno del conto (piano dei conti)
     */
    public static final String VISTA_PC_CONTO = "vistapcconto";
     ...
     * (oltre a quelli standard della superclasse)
     */
    public static final String CAMPO_ALB_SOTTOCONTO = Generale.CAMPO_SIGLA;

    public static final String CAMPO_DESCRIZIONE = Generale.CAMPO_DESCRIZIONE;

    public static final String CAMPO_ALB_CONTO = "linkalbconto";

    /**
     * Codifica dei navigatori aggiuntivi
     */
    public static final String NAVIGATORE_ALB_CONTO = "navalbconto";
