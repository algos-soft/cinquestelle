...
/**
 * AlbSottoconto - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 */
public final class AlbSottocontoModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = AlbSottoconto.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = AlbSottoconto.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = AlbSottoconto.TITOLO_MENU;
     ...
     */
    public AlbSottocontoModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new AlbSottocontoModello());
        ...
        super.addSchedaNavCorrente(new AlbSottocontoScheda(this));
    }
    ...
    protected void creaModuli() {
        try { // prova ad eseguire il codice
            super.creaModulo(new AlbContoModulo());
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
...
//            this.getNavPop().addSchedaCorrente(new AlbSottocontoScheda(this));
            this.setSchedaPop(new AlbSottocontoScheda(this));
            ...
            nav.setNomeChiave(AlbSottoconto.NAVIGATORE_ALB_CONTO);
            nav.setUsaPannelloUnico(true);
            nav.setNomeVista(AlbSottoconto.VISTA_PC_CONTO);
     ...
     */
    public static AlbSottocontoModulo get() {
        return (AlbSottocontoModulo)ModuloBase.get(AlbSottocontoModulo.NOME_CHIAVE);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new AlbSottocontoModulo();
