...
/**
 * AlbConto - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 */
public final class AlbContoModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = AlbConto.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = AlbConto.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = AlbConto.TITOLO_MENU;
     ...
     */
    public AlbContoModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new AlbContoModello());
        ...
        super.addSchedaNavCorrente(new AlbContoScheda(this));
    }
    ...
    protected void creaModuli() {
        try { // prova ad eseguire il codice
            super.creaModulo(new AlbMastroModulo());
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
    ...
    protected void creaNavigatori() {
        ...
        try { // prova ad eseguire il codice
            ...
            /* regola la scheda del popup */
//            this.getNavPop().addSchedaCorrente(new AlbContoScheda(this));
            this.setSchedaPop(new AlbContoScheda(this));

            /* modifica i bottoni della toolbar della lista */
            this.getNavigatoreDefault().setUsaFrecceSpostaOrdineLista(true);

            /* crea un navigatore per il mastro */
            nav = NavigatoreFactory.listaScheda(this);
            nav.setNomeChiave(AlbConto.NAVIGATORE_ALB_MASTRO);
            nav.setUsaPannelloUnico(true);
            nav.addScheda(new SchedaDefault(this, AlbConto.SET_ALB_MASTRO));
            nav.getPortaleLista().getToolBar().setUsaNuovo(false);
            nav.getPortaleLista().getToolBar().setUsaElimina(false);
    ...
    protected void addModuliVisibili() {
        try { // prova ad eseguire il codice
            super.addModuloVisibile(AlbMastro.NOME_MODULO);
     ...
     */
    public static AlbContoModulo get() {
        return (AlbContoModulo)ModuloBase.get(AlbContoModulo.NOME_CHIAVE);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new AlbContoModulo();
