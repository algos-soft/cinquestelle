 ...
 * @author gac
 * @version 1.0    / 4-mag-2004 ore 8.41.44
 */
public interface Autorita {
     ...
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "AutoritaDocumento";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "autoritadocumento";

    /**
     * Codifica del titolo della finestra
     * (usato nel Navigatore)
     */
    public static final String TITOLO_FINESTRA = "Autorita documenti";
