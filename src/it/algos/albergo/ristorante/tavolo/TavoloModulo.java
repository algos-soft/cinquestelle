...
import it.algos.albergo.ristorante.sala.SalaModulo;
 ...
 */
public final class TavoloModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = Tavolo.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = Tavolo.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = Tavolo.TITOLO_MENU;
     ...
     */
    public TavoloModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new TavoloModello());
...
//        this.setModoAvvio(ModoAvvio.paletta);
    ...
    /**
     * Creazione di navigatori specifici.
     * <p/>
     */
    protected void creaNavigatori() {
        ...
        try {    // prova ad eseguire il codice
            ...
            nav = new TavoloNavigatore(this);
            nav.setLista(new TavoloLista());
            nav.addScheda(new TavoloScheda(this));
    ...
    protected void creaModuli() {
        try { // prova ad eseguire il codice
            ...
            super.creaModulo(new SalaModulo());
    ...
    protected void addModuliVisibili() {
        try { // prova ad eseguire il codice
            super.addModuloVisibile(Sala.NOME_MODULO);
     ...
     */
    public static TavoloModulo get() {
        return (TavoloModulo)ModuloBase.get(TavoloModulo.NOME_CHIAVE);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new TavoloModulo();
