...
/**
 * Fisso - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 * @author gac
 * @version 1.0    / 20-gen-2005 ore 7.41.29
 */
public final class FissoModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = Fisso.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = Fisso.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = Fisso.TITOLO_MENU;
     ...
     */
    public FissoModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new FissoModello());
    ...
    protected void creaNavigatori() {
        ...
        try { // prova ad eseguire il codice
            ...
            nav = new FissoNavigatore(this);
            nav.setNomeChiave("navigatore2");
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new FissoModulo();
