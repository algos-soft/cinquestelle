...
/**
 * Ristorante - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 * @author gac
 * @version 1.0    / 25-gen-2005 ore 7.35.28
 */
public final class RistoranteModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = Ristorante.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = Ristorante.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = Ristorante.TITOLO_MENU;
     ...
     */
    public RistoranteModulo(AlberoNodo unNodo) {
...
//        super.setModello(new RistoranteModello());
