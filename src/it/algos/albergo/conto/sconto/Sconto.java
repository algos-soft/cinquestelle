...
public interface Sconto {
     ...
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "Sconto";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "sconto";

    /**
     * Codifica del titolo della finestra
     * (usato nel Navigatore)
     */
    public static final String TITOLO_FINESTRA = "Sconti";

    /**
     * Codifica del titolo del modulo come appare nel Menu Moduli
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Sconti";

    /**
     * Codifica del titolo della tabella come appare nella altre Liste
     * (usato nel Modello)
     */
    public static final String TITOLO_TABELLA = Sconto.NOME_TAVOLA;
    ...
    public enum Cam implements Campi {
        ...
        public String getNomeCompleto() {
            return Sconto.NOME_MODULO + "." + nome;
        }
