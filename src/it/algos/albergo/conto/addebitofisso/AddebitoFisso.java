 ...
 */
public interface AddebitoFisso extends Generale {

    /**
     * Codifica del nome-chiave interno del modulo
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "AddebitoFisso";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "addebitofisso";

    /**
     * Codifica del titolo della finestra
     * (usato nel Navigatore)
     */
    public static final String TITOLO_FINESTRA = "Addebiti giornalieri";

    /**
     * Codifica del titolo del modulo come appare nel Menu Moduli
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Addebiti giornalieri";
     ...
     */
    public static final String NAVIGATORE_CONTO = "navcontofisso";
    ...
    public enum Cam implements Campi {
        ...
        dataInizioValidita("datainiziovalidita", "dal", "dal", "", false),
        dataFineValidita("datafinevalidita", "al", "al", "", false),
//        dataFineAddebito("datafineaddebito", "al", "al", "", false),
        dataSincro("datasincro", "ultimo", "ultimo", "ultimo addebito", false),;
