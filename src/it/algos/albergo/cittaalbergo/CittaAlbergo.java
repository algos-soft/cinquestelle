...
public interface CittaAlbergo {

//    /**
//     * Codifica del nome-chiave interno del modulo
//     * (usato nel Modulo)
//     */
//    public static final String NOME_MODULO = Citta.NOME_MODULO;
    
//    /**
//     * Codifica della tavola di archivio collegata
//     * (usato nel Modello)
//     */
//    public static final String NOME_TAVOLA = Citta.NOME_TAVOLA;
    ...
    public enum Cam implements Campi {
        ...
        codicePS("codicePS", "", "cod. P.S.", "codice di P.S. 9 car", false);
...
//            return CittaAlbergo.NOME_MODULO + "." + nome;
//        }
