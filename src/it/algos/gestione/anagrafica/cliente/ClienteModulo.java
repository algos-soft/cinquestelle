...
/**
 * ClienteModulo - Contenitore dei riferimenti agli oggetti del package.
 * </p>
 ...
 * @author gac
 * @version 1.0    / 8-feb-2004 ore 21.51.29
 */
public class ClienteModulo extends AnagraficaModulo {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = Cliente.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = Cliente.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = Cliente.TITOLO_MENU;
     ...
     */
    public ClienteModulo(AlberoNodo unNodo) {
     ...
     * @param unNodo nodo dell'albero moduli
     */
    public ClienteModulo(String unNomeModulo, AlberoNodo unNodo) {
        /* rimanda al costruttore della superclasse */
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new ClienteModello());
     ...
     */
    public static ClienteModulo get() {
        return (ClienteModulo)ModuloBase.get(NOME_CHIAVE);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new ClienteModulo();
