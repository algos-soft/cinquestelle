 ...
 * Date:      8-feb-2004
 */
package it.algos.gestione.anagrafica.tabelle.titolo;
...
/**
 * TitoloModulo - Contenitore dei riferimenti agli oggetti del package.
 * </p>
 ...
 * @author gac
 * @version 1.0    / 8-feb-2004 ore 20.19.51
 */
public final class TitoloModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = Titolo.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = Titolo.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = Titolo.TITOLO_MENU;
     ...
     */
    public TitoloModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new TitoloModello());
     ...
     */
    public static TitoloModulo get() {
        return (TitoloModulo)ModuloBase.get(NOME_CHIAVE);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new TitoloModulo();
