...
package it.algos.gestione.rubrica.tabelle.categoria;
...
/**
 * CatRubrica - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 * @author gac
 * @version 1.0 / 17-7-2007
 */
public final class CatRubricaModulo extends ModuloBase implements CatRubrica {
     ...
     */
    public CatRubricaModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new CatRubricaModello());
     ...
     */
    public static CatRubricaModulo get() {
        return (CatRubricaModulo)ModuloBase.get(NOME_MODULO);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new CatRubricaModulo();
