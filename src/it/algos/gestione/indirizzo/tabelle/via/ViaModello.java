...
/**
 * Tracciato record della tavola Via.
 * </p>
 ...
 * @version 1.0 / 3-4-05
 */
public final class ViaModello extends ModelloAlgos {
    ...
    protected void creaCampi() {
        ...
        try { // prova ad eseguire il codice
            ...
            /* campo sigla */
            unCampo = CampoFactory.testo(Via.Cam.sigla);
    ...
    protected void creaViste() {
        ...
        super.addVista(Via.Vis.sigla.toString(), Via.Cam.sigla.get());
    }
    ...
    protected void regolaViste() {
        ...
        try { // prova ad eseguire il codice
            unaVista = this.getVista(Via.Vis.sigla);
            unCampo = unaVista.getCampo(Via.Cam.sigla);
    ...
    public EstrattoBase getEstratto(Estratti estratto, Object chiave) {
        ...
        try { // prova ad eseguire il codice
            ...
            switch ((Via.Est)estratto) {
                case sigla:
                    unEstratto = this.getEstratto(estratto, chiave, Via.Cam.sigla.get());
                    break;
