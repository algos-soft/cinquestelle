 ...
 */
public final class NazioneAzImport extends AzSpecifica {
     ...
     */
    public NazioneAzImport(Modulo modulo) {
    ...
    private void inizia() throws Exception {
        /* regola le variabili*/
        super.setChiave("NazioneAzImport");
        super.setNome("Import");
        super.setTooltip("Creazione iniziale delle nazioni");
        super.setHelp("");
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            new NazioneImport(this.getModulo(), true);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
