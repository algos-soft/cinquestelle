 ...
 */
public final class RegioneAzImport extends AzSpecifica {
     ...
     */
    public RegioneAzImport(Modulo modulo) {
    ...
    private void inizia() throws Exception {
        /* regola le variabili*/
        super.setChiave("RegioneAzImport");
        super.setNome("Import");
        super.setTooltip("Creazione iniziale delle regioni italiane");
        super.setHelp("");
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            new RegioneImport(this.getModulo(), true);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
