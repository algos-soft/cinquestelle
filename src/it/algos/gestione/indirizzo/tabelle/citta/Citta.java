...
public interface Citta extends Generale {
     ...
     */
    public static final String TITOLO_FINESTRA = "Città";

    /**
     * Codifica del voce del modulo come appare nel Menu Moduli
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Città";
    ...
    public enum Cam implements Campi {
        ...
        citta("nome", "località", "località", "nome completo della città", true),
