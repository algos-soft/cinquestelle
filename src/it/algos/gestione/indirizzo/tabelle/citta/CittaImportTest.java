 ...
 */
public final class CittaImportTest extends DialogoImport {


    private LinkedHashMap<String, Integer> mappaPro = null;

    private Albero nazioni;
     ...
     */
    public CittaImportTest(Modulo modulo, boolean mostraDialogo) {
    ...
    private void creaNazioni() {
        ...
        Albero albero = null;
        AlberoNodo nodo1 = null;
        AlberoNodo nodo2 = null;
        Campo campo;
        ...
        try { // prova ad eseguire il codice
            ...
            if (continua) {
                nodo1 = new AlberoNodo("Primo livello");
                nodo1.setNomeChiave("Francia");
                albero.addNodo(nodo1, null);

                campo = CampoFactory.checkBox("Piccardia");
                campo.decora().eliminaEtichetta();
                campo.setTestoComponente("Piccardia");
                nodo2 = new AlberoNodo(campo);
//                nodo2.setNomeChiave("Piccardia");
                albero.addNodo(nodo2, nodo1);

                nodo2 = new AlberoNodo("Beta");
                nodo2.setNomeChiave("Lorena");
                albero.addNodo(nodo2, nodo1);

                nodo2 = new AlberoNodo("Gamma");
                nodo2.setNomeChiave("Corsica");
                albero.addNodo(nodo2, nodo1);

                this.setNazioni(albero);
            }// fine del blocco if
    ...
    private void addCheckNazioni() {
        ...
        try { // prova ad eseguire il codice
            ...
            if (continua) {
//                nodi = nazioni.getNodi();
//                for (AlberoNodo naz : nodi) {
//                    nome = naz.getNomeChiave();
...
//                } // fine del ciclo for-each
                ...
                super.getPrimaPagina().aggiungeComponenti(nazioni);
...
//            nazioni = this.getNazioni();
    ...
    private Albero getNazioni() {
        return nazioni;
    }


    private void setNazioni(Albero nazioni) {
