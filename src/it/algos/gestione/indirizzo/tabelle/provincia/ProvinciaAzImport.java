 ...
 */
public final class ProvinciaAzImport extends AzSpecifica {
     ...
     */
    public ProvinciaAzImport(Modulo modulo) {
    ...
    private void inizia() throws Exception {
        /* regola le variabili*/
        super.setChiave("ProvinciaAzImport");
        super.setNome("Import");
        super.setTooltip("Creazione iniziale delle province");
        super.setHelp("");
    ...
    public void actionPerformed(ActionEvent unEvento) {
        try { // prova ad eseguire il codice
            new ProvinciaImport(this.getModulo(), true);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
