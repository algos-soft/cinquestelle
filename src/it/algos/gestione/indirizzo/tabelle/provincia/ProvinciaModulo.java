 ...
 * @version 1.0 / 3-4-05
 */
public class ProvinciaModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = Provincia.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = Provincia.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = Provincia.TITOLO_MENU;
     ...
     */
    public ProvinciaModulo(AlberoNodo unNodo) {
     ...
     * @param unNodo nodo dell'albero moduli
     */
    public ProvinciaModulo(String unNomeModulo, AlberoNodo unNodo) {
        /* rimanda al costruttore della superclasse */
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new ProvinciaModello());
        ...
        super.addSchedaNavCorrente(new ProvinciaScheda(this));
    }
    ...
    protected void creaNavigatori() {
        ...
        try { // prova ad eseguire il codice
            ...
            nav.setNomeVista(Provincia.Vis.prov.toString());
            this.addNavigatore(nav, Provincia.Nav.prov.toString());
...
//            super.creaModulo(new RegioneModulo());
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }// fine del metodo
...
//            super.addModuloVisibile(Regione.NOME_MODULO);
    ...
    protected void creaAzioni() {
        try { // prova ad eseguire il codice
            ...
            /* download dal server */
            super.addAzione(new ProvinciaAzImport(this), Navigatore.Tool.menu);
    ...
    public void setup() {
        try { // prova ad eseguire il codice
            new ProvinciaImport(this, false);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
     ...
     */
    public static ProvinciaModulo get() {
        return (ProvinciaModulo)ModuloBase.get(NOME_CHIAVE);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new ProvinciaModulo();
