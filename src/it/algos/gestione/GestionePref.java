 ...
 */
public class GestionePref extends Pref {


    /**
     * Classe interna Enumerazione.
     */
    public enum Doc implements PrefGruppi {

        bloccoUno("",
                "primo blocco",
                "primo blocco di testo per la testata del documento",
                Utente.user,
                TipoDati.area,
                null,
                "",
        ...
        bloccoDue("",
                "secondo blocco",
                "secondo blocco di testo per la testata del documento",
                Utente.user,
                TipoDati.area,
                null,
                "",
        ...
        bloccoTre("",
                "terzo blocco",
                "terzo blocco di testo per la testata del documento",
                Utente.user,
                TipoDati.area,
                null,
                "",
        ...
        bloccoQuattro("",
                "quarto blocco",
                "quarto blocco di testo per la testata del documento",
                Utente.user,
                TipoDati.area,
                null,
                "",
     ...
     * Classe interna Enumerazione.
     */
    public enum Azienda implements PrefGruppi {

        /* tipologia aziendale di chi usa il programma (azienda, professionista,...) */
        tipo("tipoAzienda",
                "Tipologia aziendale",
                Utente.admin,
                TipoDati.combo,
                Gestione.ModFatt.getLista(),
                Gestione.ModFatt.professionista.ordinal(),
                "",
                "",
                true,
                true,
    ...
    private void inizia() throws Exception {
        try { // prova ad eseguire il codice
            this.addGruppo(GestionePref.Doc.class);
            this.addGruppo(GestionePref.Azienda.class);
            Pref.carica();
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
