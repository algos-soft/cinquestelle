...
import it.algos.gestione.GestionePref;
 ...
 */
public final class FattBasePref extends GestionePref {


    /**
     * Classe interna Enumerazione.
     */
    public enum Fatt implements PrefGruppi {

//        /**
//         * codice IVA di default - deve esistere nella tabella !
//         * superato dalle impostazioni dell'anagrafica specifica
//         */
//        codIvaDefault("",
//                  "codIvaDefault",
...
//                      null,
//                      1,
//                      "Usato alla creazione di una nuova fattura",
//                      "",
//                      true,
//                      true,
//                      false),

        /* se applicare la rivalsa INPS in fattura */
        applicaRivalsa("",
                "applicaRivINPS",
                "Applicazione rivalsa INPS",
                Utente.user,
                TipoDati.booleano,
                null,
                true,
                "Applicazione rivalsa INPS in fattura",
                "",
                true,
                true,
                false),

        /* percentuale di rivalsa INPS in fattura */
        percRivalsa("",
                "percRivalsa",
                ...
                null,
                4,
                "Percentuale di rivalsa INPS",
                "",
                true,
                true,
                false),

        /* se applicare la ritenuta d'acconto in fattura */
        applicaRa("",
                "applicaRa",
                "Applicazione R.A.",
                Utente.user,
                ...
                null,
                true,
                "Applicazione ritenuta d'acconto in fattura",
                "",
                true,
                true,
                false),

        /* percentuale di ritenuta d'acconto in fattura */
        percRa("",
                "percRa",
                "Percentuale R.A.",
                Utente.user,
...
//        /* codice di pagamento di default */
//        codPagamentoDefault("codPagamentoDefault",
//                            "Codice di pagamento di default",
//                            Utente.user,
//                            TipoDati.intero,
//                            null,
...
//                            false),
    ...
    private void inizia() throws Exception {
        try { // prova ad eseguire il codice
            this.addGruppo(FattBasePref.Fatt.class);
            Pref.carica();
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
