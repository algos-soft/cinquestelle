 ...
 * Date:      9-feb-2004
 */
package it.algos.gestione.fattura.tabelle.causale;
...
/**
 * CausaleModulo - Contenitore dei riferimenti agli oggetti del package.
 * </p>
 ...
 * @author gac
 * @version 1.0    / 9-feb-2004 ore 7.49.23
 */
public final class CausaleModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = Causale.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = Causale.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = Causale.TITOLO_MENU;
     ...
     */
    public CausaleModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new CausaleModello());
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new CausaleModulo();
