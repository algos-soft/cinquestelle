 ...
 */
public interface Ddt extends Generale {

    /**
     * Codifica del nome-chiave interno del modulo
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "Ddt";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "ddt";

    /**
     * Codifica del voce della finestra
     * (usato nel Navigatore)
     */
    public static final String TITOLO_FINESTRA = "Documento di trasporto";

    /**
     * Codifica del voce del modulo come appare nel Menu Moduli
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Documento di trasporto";
    ...
    public enum Cam implements Campi {
        ...
        sigla("sigla", "", "", legendaSigla, true),
        descrizione("descrizione", "", "", legendaDescrizione, true);
