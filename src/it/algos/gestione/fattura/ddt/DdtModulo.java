...
/**
 * Ddt - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 */
public final class DdtModulo extends FattBaseModulo {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = "Ddt";

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = "Documenti di trasporto";

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = "Documenti di trasporto";

    /**
     * nome del programma che compare in basso (se vuoto, usa il default)
     * viene usato il nome del modulo che parte per primo
     */
    private static final String NOME_PROGRAMMA = "Documenti di trasporto";
     ...
     */
    public DdtModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        this.setTipoDocumento(FattBase.TipoDoc.docTrasporto);

        /* selezione del modello (obbligatorio) */
        super.setModello(new DdtModello());
    }
     ...
     */
    public static DdtModulo get() {
        return (DdtModulo)ModuloBase.get(NOME_CHIAVE);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new DdtModulo();
