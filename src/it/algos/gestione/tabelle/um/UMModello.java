...
/**
 * Tracciato record della tavola UM.
 * </p>
 ...
 */
public final class UMModello extends ModelloAlgos implements UM {
    ...
    protected void creaViste() {
        ...
        try { // prova ad eseguire il codice
            ...
            super.addVista(Vis.sigla, Cam.sigla);
    ...
    protected void regolaViste() {
        ...
        try { // prova ad eseguire il codice
            unaVista = this.getVista(Vis.sigla);
            unCampo = unaVista.getCampo(Cam.sigla);
