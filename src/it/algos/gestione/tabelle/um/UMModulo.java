...
package it.algos.gestione.tabelle.um;
...
/**
 * UM - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 */
public final class UMModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = UM.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = UM.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = UM.TITOLO_MENU;
     ...
     */
    public UMModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new UMModello());
     ...
     */
    public static UMModulo get() {
        return (UMModulo)ModuloBase.get(NOME_CHIAVE);
    }
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new UMModulo();
