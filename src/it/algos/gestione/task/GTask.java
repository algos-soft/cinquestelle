 ...
 */
public interface GTask extends Generale {

    /**
     * Codifica del nome-chiave interno del modulo
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "Gtask";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "task";

    /**
     * Codifica del titolo della finestra
     * (usato nel Navigatore)
     */
    public static final String TITOLO_FINESTRA = "Tasks";

    /**
     * Codifica del titolo del modulo come appare nel Menu Moduli
     * (usato nel Navigatore)
     */
    public static final String TITOLO_MENU = "Tasks";
    ...
    public enum Cam implements Campi {
        ...
        sigla("", "task", "task", "", true),
        descrizione("", "", "", "", false),
        giornilavorazione("",
                "gg lav",
                "giorni di lavorazione",
                "giorni di lavorazione necessari",
                true),
        dataInizio("", "data inizio", "data inizio", "inizio lavorazione suggerita", true),
        dataUtile("datautile", "data utile", "data utile", "entro la quale va terminato", true),
        evaso("", "ev", "evaso", "", true),;
