...
package it.algos.gestione.pianodeiconti.sottoconto;
...
/**
 * Tracciato record della tavola PCSottoconto.
 * </p>
 ...
 */
public class PCSottocontoModello extends ModelloAlgos implements PCSottoconto {
     ...
     */
    private static final String COLONNA_SIGLA = "sottoconti";
    ...
    protected static final String TESTO_CONTO = "conto di appartenenza";
     ...
     */
    protected static final String LEGENDA_DESCRIZIONE = "descrizione completa del sottoconto";


    /**
     * Costruttore completo senza parametri.
     */
    public PCSottocontoModello() {
    ...
    protected void creaCampi() {
        ...
        try { // prova ad eseguire il codice
            ...
            /* campo link conto */
            unCampo = CampoFactory.comboLinkPop(CAMPO_CONTO);
            unCampo.decora().obbligatorio();
            unCampo.decora().etichetta(TESTO_CONTO);
            unCampo.setNomeModuloLinkato(PCConto.NOME_MODULO);
            unCampo.decora().estrattoSotto(PCConto.Estratto.descrizione);
