...
import it.algos.gestione.pianodeiconti.conto.PCContoModulo;

/**
 * PCSottoconto - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 */
public final class PCSottocontoModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = PCSottoconto.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = PCSottoconto.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = PCSottoconto.TITOLO_MENU;
     ...
     */
    public PCSottocontoModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new PCSottocontoModello());
    ...
    protected void creaModuli() {
        try { // prova ad eseguire il codice
            super.creaModulo(new PCContoModulo());
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
    ...
    protected void creaNavigatori() {
        ...
        try { // prova ad eseguire il codice
            ...
            nav.setNomeChiave(PCSottoconto.NAVIGATORE_CONTO);
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new PCSottocontoModulo();
