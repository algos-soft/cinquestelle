...
/**
 * PCMastro - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 */
public class PCMastroModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = PCMastro.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = PCMastro.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = PCMastro.TITOLO_MENU;
     ...
     */
    public PCMastroModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new PCMastroModello());
        ...
        super.addSchedaNavCorrente(new PCMastroScheda(this));
    }
    ...
    protected void addModuliVisibili() {
        try { // prova ad eseguire il codice
            super.addModuloVisibile(PCConto.NOME_MODULO);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }// fine del metodo
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new PCMastroModulo();
