...
import it.algos.gestione.pianodeiconti.mastro.PCMastroModulo;
import it.algos.gestione.pianodeiconti.sottoconto.PCSottoconto;

/**
 * PCConto - Contenitore dei riferimenti agli oggetti del package.
 * <p/>
 ...
 */
public final class PCContoModulo extends ModuloBase {

    /**
     * Nome-chiave interno di questo modulo (obbligatorio)
     */
    private static final String NOME_CHIAVE = PCConto.NOME_MODULO;

    /**
     * Titolo della finestra del navigatore
     * (usato nel Navigatore)
     */
    private static final String TITOLO_FINESTRA = PCConto.TITOLO_FINESTRA;

    /**
     * Titolo del modulo come appare nel Menu Moduli degli altri moduli
     * (usato nel Navigatore)
     */
    private static final String TITOLO_MENU = PCConto.TITOLO_MENU;
     ...
     */
    public PCContoModulo(AlberoNodo unNodo) {
    ...
    private void inizia() throws Exception {
        ...
        super.setModello(new PCContoModello());
        ...
        super.addSchedaNavCorrente(new PCContoScheda(this));
    }
    ...
    protected void creaModuli() {
        try { // prova ad eseguire il codice
            super.creaModulo(new PCMastroModulo());
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }
    ...
    protected void creaNavigatori() {
        ...
        try { // prova ad eseguire il codice
            ...
            nav.setNomeChiave(PCConto.NAVIGATORE_MASTRO);
            nav.setUsaPannelloUnico(true);
            nav.addScheda(new SchedaDefault(this, PCConto.SET_MASTRO));
    ...
    protected void addModuliVisibili() {
        try { // prova ad eseguire il codice
            super.addModuloVisibile(PCMastro.NOME_MODULO);
            super.addModuloVisibile(PCSottoconto.NOME_MODULO);
        } catch (Exception unErrore) { // intercetta l'errore
            Errore.crea(unErrore);
        }// fine del blocco try-catch
    }// fine del metodo
    ...
    public static void main(String[] argomenti) {
        ...
        Modulo primoModuloProvvisorio = new PCContoModulo();
