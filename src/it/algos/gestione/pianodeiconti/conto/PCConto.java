 ...
 */
public interface PCConto extends Generale {

    /**
     * Codifica del nome-chiave interno del modulo
     * (usato nel Modulo)
     */
    public static final String NOME_MODULO = "PCConto";

    /**
     * Codifica della tavola di archivio collegata
     * (usato nel Modello)
     */
    public static final String NOME_TAVOLA = "pcconto";
     ...
     * (ATTENZIONE - il nome del Set DEVE essere diverso dai nomi dei campi)
     */
    public static final String SET_MASTRO = "setmastro";

    /**
     * Codifica dei nomi dei campi (per il modello e per la scheda)
     * (oltre a quelli standard della superclasse)
     */
    public static final String CAMPO_CONTO = Generale.CAMPO_SIGLA;

    public static final String CAMPO_DESCRIZIONE = Generale.CAMPO_DESCRIZIONE;

    public static final String CAMPO_MASTRO = "linkmastro";

    public static final String CAMPO_SOTTOCONTI = "sottoconti";

    /**
     * Codifica dei navigatori aggiuntivi
     */
    public static final String NAVIGATORE_MASTRO = "navmastro";
